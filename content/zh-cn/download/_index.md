...
- **用着有问题**：到 [Live-ISO issues](https://github.com/gentoo-zh/Live-ISO/issues) 报缺陷，或去[社区论坛](https://forum.gentoozh.org/)、[Telegram 群](https://t.me/gentoo_zh)提问；也可以写信到 liveos@gentoozh.org。
